...
//     lastName: 'niga',
//     age: 18,
//     mail: 'canegame2548@gmail.com',
//     phone: '09xxxxxx76',
//     idCord: 'xxxxxxxxxxxxxxxx',
//     fan: {
//         firstName: 'nigga',
//         lastName: 'lamo',
//         age: '13',
...
//     }
// }
// console.log(aboutMe.Myfirend.AKA)
...
const myFirendAKA = Myfirend.map(function (element, index) {
    return ({
...
const MyfirendMoreAge = Myfirend.filter(function(element, index) {
    return element.age > 19
})

console.log(MyfirendMoreAge)
...
const covidDeath = detabase.filter(function (element, index) {
    return element.total_death > 5 && element.province !== 'ทั้งประเทศ'
})

const covidDeathOnlyProvince = covidDeath.map(function (element, index) {
    return ({
...
for (let i = 0; i < detabase.length; i++) {
    if (detabase[i].total_death > 5) {
    }
}
console.log('filter wirh for loop', covidProvince)
const news = {
    "status": "success",
    "totalResults": 2373,
    "results": [
...
const thainews = news.results.filter(function (element, index) {
    return element.language !== 'english' && element.source_name === 'Thai Pbs News'
